...
public class CommandMessage extends Message {
     ...
     * @param message The string message to convert to Messages
     */
     ...
     * @param parent The parent of this message
     * @param messages The children of this message.
     */
     ...
     * Creates a new CommandMessage.
     * @param parent The parent of this message
     * @param message The child of this message.
     */
    ...
    public static CommandMessage splitMessage(CommandMessage parent, String message) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            // When we can co any level lower (closer to 0), and we're currently
            ...
            } else if (!inString && !firstWordInCommand && c == '!' &&
                    Character.isWhitespace(message.charAt(i-1))) {
                matchedWord += c;
                level++;
            ...
            // start the string.
                ...
                if (inString) {
                    // Test whether the next character is a whitespace character.
                    ...
                    // Test whether the prev character is a whitespace character.
                    // If not, it's not a special case.
                    if (i > 0) {
            ...
            // When we're not in a string and encouter a whitespace character,
