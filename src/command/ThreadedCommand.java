...
public abstract class ThreadedCommand extends Command implements Runnable {
     ...
     * upon call.
     * 
     * @see Command#receive(qorebot.Channel, qorebot.User, command.CommandMessage) 
     */
    @Override
    ...
    /**
     * This method continues to check whether there's a new item in the queue
     * to handle. When a new one is available, it will execute the handleEvent-
     * method.
     */
    @Override
    public void run() {
     ...
     *
     * @param channel The channel the message was received on. May be null.
     * @param user The user who sent the message. May not be null.
     * @param msg The sent message. May not be null.
